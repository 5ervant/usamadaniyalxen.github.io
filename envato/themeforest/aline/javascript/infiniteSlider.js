...
InfiniteSlider.prototype.changeSlide = function(current, clicked, _infiniteSlider) {
    ...
    $(_infiniteSlider.infos).fadeOut(_infiniteSlider.speed / 2, function() {
        ...
        $(this).animate({
            opacity: 1
        }, _infiniteSlider.speed / 2, function() {
    ...
    if (_infiniteSlider.mode == 'slide') {
        ...
        if (direction == 'next') {
            ...
            // Animate slides
            $('> ul > li', _infiniteSlider.container).eq(current).animate({
                top: '-150%'
            }, {
                'duration': _infiniteSlider.speed,
                easing: _infiniteSlider.easing,
            ...
            $('> ul > li', _infiniteSlider.container).eq(clicked).animate({
                top: 0
            }, {
                'duration': _infiniteSlider.speed,
                easing: _infiniteSlider.easing
        ...
        }, _infiniteSlider.speed, _infiniteSlider.easing, function() {
        ...
        $('> ul > li', _infiniteSlider.container).eq(current).find('.columns > li > div').animate({
            width: 0
        }, _infiniteSlider.speed, _infiniteSlider.easing, function() {

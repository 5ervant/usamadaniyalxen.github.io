...
$(window).load(function() {
    ...
    $('#services_single .block-video .video-container .overlay').on('click', function() {
        ...
        switch (vidType) {
            case 'youtube':
                var innerHtml = '<iframe width="560" height="315" src="https://www.youtube.com/embed/' + vidID + '?rel=0&autoplay=1" frameborder="0" allowfullscreen></iframe>';
                break;

            case 'vimeo':
                var innerHtml = '<iframe src="https://player.vimeo.com/video/' + vidID + '?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1&amp;color=ffffff" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
                break;
...
function insertClip(clp, rt, w_, h_) {
    swfObject = '<iframe frameborder="0" marginheight="0" marginwidth="0" src="https://www.infosignmedia.com/solo/validator.php?clp=' + clp + '&root=' + rt + '&autoplay=true&brandlink=servdentist.com&brandtxt=ServDentist.com&abr=full"  type="text/php" scrolling="no" width="' + w_ + '" height="' + h_ + '"></iframe>';
    return swfObject;
}

function insertClipVzaar(clp, rt, w_, h_, ap, txt, lk, abr) {
    if (txt == "s") {
        txt = lk = "ServDentist.com" // Add your WEBSITE url here...
    };
    if (abr != "short") {
        abr = "full";
    };
    swfObject = '<iframe frameborder="0" marginheight="0" marginwidth="0" src="https://www.infosignmedia.com/solo/validator.php?clp=' + clp + '&root=' + rt + '&autoplay=' + ap + '&brandlink=' + lk + '&brandtxt=' + txt + '&abr=' + abr + '"  type="text/php" scrolling="no" width="' + w_ + '" height="' + h_ + '"></iframe>';
    return swfObject;
}

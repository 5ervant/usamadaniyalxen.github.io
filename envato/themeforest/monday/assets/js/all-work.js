...
window.Modernizr = function(e, t, n) {
        ...
        var a, i, c, l = "2.6.2",
            ...
            g = y.slice,
            v = {}.hasOwnProperty;
        c = o(v, "undefined") || o(v.call, "undefined") ? function(e, t) {
        ...
        for (var E in m) c(m, E) && (i = E.toLowerCase(), s[i] = m[E](), y.push((s[i] ? "" : "no-") + i));
        return s.addTest = function(e, t) {
                if ("object" == typeof e)
                    for (var r in e) c(e, r) && s.addTest(r, e[r]);
                else {
                    if (e = e.toLowerCase(), s[e] !== n) return s;
                    t = "function" == typeof t ? t() : t, "undefined" != typeof u && u && (f.className += " " + (t ? "" : "no-") + e), s[e] = t
                }
                return s
            }, r(""), p = a = null,
            function(e, t) {
                ...
                function a(e, n, r) {
                    ...
                    r || (r = o(n));
                    var a;
                    return a = r.cache[e] ? r.cache[e].cloneNode() : p.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), a.canHaveChildren && !d.test(e) ? r.frag.appendChild(a) : a
                }
                ...
                e.html5 = g, l(t)
            }(this, t), s._version = l, f.className = f.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (u ? " js " + y.join(" ") : ""), s
    }(this, this.document),
    function(e, t, n) {
        function r(e) {
        ...
        function l(e, n, r, o, a, l, s) {
            function u(t) {
                if (!p && i(f.readyState) && (E.r = p = 1, !v && c(), f.onload = f.onreadystatechange = null, t)) {
                    "img" != e && h(function() {
                        S.removeChild(f)
                    }, 50);
            ...
            1 === N[n] && (y = 1, N[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), f.width = f.height = "0", f.onerror = f.onload = f.onreadystatechange = function() {
                u.call(this, y)
            }, g.splice(o, 0, E), "img" != e && (y || 2 === N[n] ? (S.insertBefore(f, b ? null : m), h(u, s)) : N[n].push(f))
        }

        function s(e, t, n, r, a) {
            return v = 0, t = t || "j", o(e) ? l("c" == t ? C : j, e, t, this.i++, n, r, a) : (g.splice(this.i++, 0, e), 1 == g.length && c()), this
        }
        ...
        d = function(e) {
            ...
            function i(e, o, a, i, c) {
                var l = t(e),
                    s = l.autoCallback;
                l.url.split(".").pop().split("?").shift(), l.bypass || (o && (o = r(o) ? o : o[e] || o[i] || o[e.split("/").pop().split("?")[0]]), l.instead ? l.instead(e, o, a, i, c) : (N[l.url] ? l.noexec = !0 : N[l.url] = 1, a.load(l.url, l.forceCSS || !l.forceJS && "css" == l.url.split(".").pop().split("?").shift() ? "c" : n, l.noexec, l.attrs, l.timeout), (r(o) || r(s)) && a.load(function() {
                    u(), o && o(l.origUrl, c, i), s && s(l.origUrl, c, i), N[l.url] = 2
                })))
            }
            ...
            if (o(e)) i(e, 0, f, 0);
                ...
                for (l = 0; l < e.length; l++) s = e[l], o(s) ? i(s, 0, f, 0) : w(s) ? d(s) : Object(s) === s && c(s, f);
            ...
            n = s ? c : n || a, p.onreadystatechange = p.onload = function() {
...
! function() {
    ...
    $(function(i) {
        i(window).load(function() {
            ...
            }), i(".iso-filter-nav a").click(function() {
                i(".iso-filter-nav .current").removeClass("current"), i(this).addClass("current");
